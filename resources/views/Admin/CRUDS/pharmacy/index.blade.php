...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">{{helperTrans('admin.Pharmacies')}}</h5>

                <div>
                    <button id="addBtn" class="btn btn-primary"> {{helperTrans('admin.Add Pharmacy')}}</button>
                </div>


            <div>
                <a href="{{route('pharmacy.export')}}"  class="btn btn-success mx-2">    <i class="fa-solid fa-file-export"></i></a>
            </div>

            <div>
                <button id="importPharmacy"  class="btn btn-danger  ">    <i class="fa-solid fa-file-import"></i></button>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> {{helperTrans('admin.Pharmacy')}} </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
    <script>
        var columns = [
            {data: 'id', name: 'id'},
            {data: 'name', name: 'name'},
            {data: 'pharmacy_branches', name: 'pharmacy_branches'},
    ...
    @include('Admin.layouts.inc.ajax',['url'=>'pharmacies'])
    ...
    <script>
        $(document).on('click','#importPharmacy',function (){
            ...
            setTimeout(function (){
                $('#form-load').load("{{route('pharmacy.import')}}")
            },1000)
        })
    </script>
