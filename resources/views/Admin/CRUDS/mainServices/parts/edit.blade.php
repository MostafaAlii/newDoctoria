...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('main_services.update',$row->id)}}">
    @csrf
    @method('PUT')
    <div class="row g-4">
        ...
        <div class="form-group">
            ...
            <input type="file" id="image" class="dropify" name="image" data-default-file="{{get_file($row->image)}}"
                   accept="image/*"/>
            <span
