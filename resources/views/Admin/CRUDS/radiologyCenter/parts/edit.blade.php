...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('radiology_centers.update',$row->id)}}">
    @csrf
    @method('PUT')
    <div class="row g-4">
    ...
    @foreach(languages() as $index=>$language)
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input type="text" id="service_price" class="form-control" name="service_price" value="{{$row->service_price}}">
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input type="time" id="fromTime" class="form-control" name="fromTime" value="{{$row->fromTime}}">
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input type="time" id="toTime" class="form-control" name="toTime" value="{{$row->toTime}}">
        </div>
