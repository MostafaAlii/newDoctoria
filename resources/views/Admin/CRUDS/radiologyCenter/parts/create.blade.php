...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('radiology_centers.store')}}">
    @csrf
    <div class="row g-4">
        ...
        @foreach(languages() as $index=>$language)
            ...
            <div class="col-sm-6 pb-3 p-2">
                <label for="desc_{{$language->abbreviation}}"
                       class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                    <span class="required mr-1">  {{helperTrans('admin.description')}}       <span
                            class="red-star">*</span></span>
                </label>
                <textarea name="desc[{{$language->abbreviation}}]" id="desc_{{$language->abbreviation}}"
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            <!--begin::Label-->
            <label for="fromTime" class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                <span class="required mr-1">{{helperTrans('admin.From Time')}} <span class="red-star">*</span></span>
            </label>
            <!--end::Label-->
            <input type="time" id="fromTime" class="form-control" name="fromTime">
        </div>

        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            <!--begin::Label-->
            <label for="toTime" class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                <span class="required mr-1">{{helperTrans('admin.To Time')}} <span class="red-star">*</span></span>
            </label>
            <!--end::Label-->
            <input type="time" id="toTime" class="form-control" name="toTime">
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input type="text" id="service_price" class="form-control" name="service_price" value="">
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input type="text" id="discount" class="form-control" name="discount" value="">
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input type="text" id="cashback" class="form-control" name="cashback" value="">
        </div>
