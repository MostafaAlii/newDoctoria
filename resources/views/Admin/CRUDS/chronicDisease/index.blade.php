...
@section('title')
    {{helperTrans('admin.Chronic Diseases')}}
@endsection
@section('css')
...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">{{helperTrans('admin.Chronic Diseases')}}</h5>
            @if(auth()->guard('admin')->user()->hasPermission('chronic_diseases_create'))

                <div>
                    <button id="addBtn" class="btn btn-primary"> {{helperTrans('admin.Add Chronic Disease')}}</button>
                </div>
            @endif
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> {{helperTrans('admin.Chronic Disease')}} </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
    ...
    @include('Admin.layouts.inc.ajax',['url'=>'chronic_diseases'])
