...
@section('title')
    {{helperTrans('admin.Doctors Branches')}}
@endsection
@section('css')
...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">{{helperTrans('admin.Doctors Branches')}}</h5>

                <div>
                    <button id="addBtn" class="btn btn-primary"> {{helperTrans('admin.Add Doctor Branch')}}</button>
                </div>
        ...
        <div class="card-body">
            <table id="table" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                ...
                <tr>
                    ...
                    <th>{{helperTrans('admin.Doctor Branches Times')}}</th>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> {{helperTrans('admin.Doctor Branch')}} </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
    <script>
        var columns = [
            ...
            {data: 'doctor_branches_times', name: 'doctor_branches_times'},
            {data: 'created_at', name: 'created_at'},
            {data: 'action', name: 'action', orderable: false, searchable: false},
        ];
    </script>
    @include('Admin.layouts.inc.ajax',['url'=>'doctors_branches', 'id'=>$doctor->id])
