...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">{{helperTrans('admin.Cities')}}</h5>
            @if(auth()->guard('admin')->user()->hasPermission('cities_create'))
                <div>
                    <button id="addBtn" class="btn btn-primary"> {{helperTrans('admin.Add City')}}</button>
                </div>
            @endif
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> {{helperTrans('admin.City')}} </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
