...
@section('title')
    {{helperTrans('admin.Notifications')}}
@endsection
@section('css')
...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">{{helperTrans('admin.Notifications')}}</h5>
        ...
        <div class="card-body">
            <table id="table" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                ...
                <tr>
                    ...
                    <th>{{helperTrans('admin.User Type')}}</th>
                    <th>{{helperTrans('admin.User')}}</th>
                    <th>{{helperTrans('admin.Type')}}</th>
                    <th>{{helperTrans('admin.date')}}</th>
                    <th>{{helperTrans('admin.Is Read')}}</th>
                    <th>{{helperTrans('admin.Body')}}</th>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> {{helperTrans('admin.Notification')}} </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
    ...
    @include('Admin.layouts.inc.ajax',['url'=>'notifications'])
