...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">{{helperTrans('admin.Sc Types')}}</h5>

                <div>
                    <button id="addBtn" class="btn btn-primary"> {{helperTrans('admin.Add Sc Type')}}</button>
                </div>
        ...
        <div class="card-body">
            <table id="table" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                ...
                <tr>
                    ...
                    <th>{{helperTrans('admin.have experience')}}</th>
                    <th>{{helperTrans('admin.Details')}}</th>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> {{helperTrans('admin.Sc Type')}} </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
    <script>
        var columns = [
            ...
            {data: 'sc_category_id', name: 'sc_category_id'},
            {data: 'have_experience', name: 'have_experience'},
            {data: 'details', name: 'details'},
            {data: 'created_at', name: 'created_at'},
            {data: 'action', name: 'action', orderable: false, searchable: false},
        ];
    </script>
    @include('Admin.layouts.inc.ajax',['url'=>'sc_types'])
