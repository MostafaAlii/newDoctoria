...
<!-- particles js -->
<script src="{{url('assets')}}/dashboard/libs/particles.js/particles.js"></script>
<!-- particles app js -->
<script src="{{url('assets')}}/dashboard/js/pages/particles.app.js"></script>
<!-- password-addon init -->
<script src="{{url('assets')}}/dashboard/js/pages/password-addon.init.js"></script>
